...
TAB1 <- tabItem(
    ...
    fluidPage(
        ...
        fluidRow(
          column(width = 4, { htmlOutput("geneInfos", height = '200px') %>% withSpinner(type = 6, color = "#421500") }),
          column(width = 2, { 
            fluidRow(
              br(),
...
TAB2 <- tabItem(
    ...
    fluidPage(
        ...
        fluidRow( 
            column(width = 7, { plotOutput("GO.plot") %>% withSpinner(type = 6, color = "#421500") } ),
            column(width = 2, { 
