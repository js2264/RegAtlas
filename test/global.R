...
list.genes <- list(hypod.genes, neurons.genes, germline.genes, muscle.genes, hypod.genes)
names(list.genes) <- c("hypod.genes", "neurons.genes", "germline.genes", "muscle.genes", 'hypod.genes')
